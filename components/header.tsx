...
import { Menu, X, Book, Film, MessageSquare, User, ChevronDown, Home, ArrowRight, PenTool, Sparkles, Mic, Megaphone } from "lucide-react"
...
export function Header() {
  ...
  const navItems = [
    ...
    { 
      label: "Announcement", 
      href: "/special-announcement",
      icon: Megaphone,
      description: "New Book Release",
      highlight: true,
      badge: "NEW"
    },
    { 
  ...
  const quickLinks = [
    { label: "Special Announcement", href: "/announcement", icon: Megaphone, highlight: true },
                  ...
                  {quickLinks.map((link) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Icon size={14} className={`${link.highlight ? 'text-[#B7C83E]' : 'text-[#B7C83E]/60'} group-hover:text-[#B7C83E] transition-colors`} />
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Announcement Dropdown - Special Styling */}
                    {activeDropdown === item.label && item.highlight && (
                      <div 
                      ...
                      >
                        ...
                        <div className="relative px-4 py-3 border-b border-[#E3E7C8]">
                          <div className="flex items-center gap-2">
                            <Megaphone size={14} className="text-[#B7C83E]" />
                            <p className="text-xs text-[#2E2F1F] uppercase tracking-widest font-cormorant">Special Announcement</p>
                          </div>
                          <p className="text-xs text-[#5F6148] mt-1">{item.description}</p>
                        </div>
                        ...
                        <div className="space-y-1 px-2">
                          ...
                          >
                            ...
                            <div>
                              <p className="text-sm font-cormorant font-medium">Yasmine and the Americans</p>
                              <p className="text-xs text-[#5F6148]/70">A Novel Reborn • March 2026</p>
                            </div>
                          </Link>
                          <Link
                            href="/press"
                          ...
                          >
                            ...
                            <div>
                              <p className="text-sm font-cormorant">Read the Announcement</p>
                              <p className="text-xs text-[#5F6148]/70">Discover the story behind the story</p>
                            </div>
                          </Link>
                        </div>
                      </div>
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    {/* Announcement badge */}
                    {item.badge && (
                      <div className="absolute -top-1 -right-1 px-1.5 py-0.5 bg-[#B7C83E] text-[#2E2F1F] text-[10px] font-bold rounded-full z-20 animate-pulse">
                        {item.badge}
                      </div>
                    )}
              ...
              <div className="pt-4 mt-2 border-t border-[#E3E7C8]">
                ...
                {quickLinks.map((link) => {
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <Icon size={14} className={`${link.highlight ? 'text-[#B7C83E]' : 'text-[#B7C83E]/50'} group-hover:text-[#B7C83E]`} />
